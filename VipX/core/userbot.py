...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.join_chat("music_bot098")
                await self.one.join_chat("music_bot098")
                await self.one.join_chat("music_bot098")
            except:
                pass
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("music_bot098")
                await self.three.join_chat("music_bot098")
                await self.three.join_chat("music_bot098")
            except:
                pass
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("music_bot098")
                await self.four.join_chat("music_bot098")
                await self.four.join_chat("music_bot098")
            except:
                pass
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("music_bot098")
                await self.five.join_chat("music_bot098")
                await self.five.join_chat("music_bot098")
            except:
                pass
