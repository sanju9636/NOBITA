...
TAGMES = [ " **𝐇𝐞𝐲 𝐁𝐚𝐛𝐲 𝐊𝐚𝐡𝐚 𝐇𝐨🥱** ",
           ...
           " **𝐇𝐞𝐦𝐥𝐨𝐨🧐** ",
           " **𝐌𝐮𝐣𝐡𝐞 𝐁𝐡𝐮𝐥 𝐆𝐲𝐞 𝐊𝐲𝐚🥺** ",
           " **𝐘𝐚𝐡𝐚 𝐀𝐚 𝐉𝐚𝐨:- [ @neet_sarthi143 ] 𝐌𝐚𝐬𝐭𝐢 𝐊𝐚𝐫𝐞𝐧𝐠𝐞 🤭🤭** ",
           " **𝐓𝐫𝐮𝐭𝐡 𝐀𝐧𝐝 𝐃𝐚𝐫𝐞 𝐊𝐡𝐞𝐥𝐨𝐠𝐞..? 😊** ",
           " **𝐀𝐚𝐣 𝐌𝐮𝐦𝐦𝐲 𝐍𝐞 𝐃𝐚𝐭𝐚 𝐘𝐫🥺🥺** ",
           " **𝐉𝐨𝐢𝐧 𝐊𝐚𝐫 𝐋𝐨:- [ @N_O_B_I_T_A_007 ] 🤗** ",
           " **𝐄𝐤 𝐃𝐢𝐥 𝐇𝐚𝐢 𝐄𝐤 𝐃𝐢𝐥 𝐇𝐢 𝐓𝐨 𝐇𝐚𝐢😗😗** ",
           " **𝐓𝐮𝐦𝐡𝐚𝐫𝐞 𝐃𝐨𝐬𝐭 𝐊𝐚𝐡𝐚 𝐆𝐲𝐞🥺** ",
           " **𝐌𝐲 𝐂𝐮𝐭𝐞 𝐎𝐰𝐧𝐞𝐫 [ @N_O_B_I_T_A_007]🥰** ",
           " **𝐊𝐚𝐡𝐚 𝐊𝐡𝐨𝐲𝐞 𝐇𝐨 𝐉𝐚𝐚𝐧😜** ",
           " **𝐆𝐨𝐨𝐝 𝐍8 𝐉𝐢 𝐁𝐡𝐮𝐭 𝐑𝐚𝐭 𝐇𝐨 𝐠𝐲𝐢🥰** ",
           " **𝗺𝗮𝗺𝗮 𝗷𝗶 𝗸𝗲 𝘀𝗲 𝗸𝗯 𝗮𝗮𝘆𝗮🥰** ",
           " **𝘀𝘁𝘂𝗱𝘆 𝗸𝗲𝘀𝗶 𝗰𝗵𝗮𝗹 𝗿𝗵𝗶 𝗵𝗮𝗶🥰** ",
           " **𝗺𝘂𝗺𝘆 𝗽𝗮𝗽𝗮 𝗸𝗲𝘀𝗲 𝗵𝗮𝗶🥰** ",
           " **𝘁𝘂𝗺 𝗻𝗲𝗲𝘁 𝗸𝗯 𝘀𝗲 𝗸𝗿 𝗿𝗵𝗲 𝗵𝗼🥰** ",
           " **𝗮𝗮𝗽 𝗸𝗮 𝗻𝗲𝗲𝘁 𝗺𝗲 𝗵𝗼 𝗴𝘆𝗮 𝗻𝗮🥰** ",
           " **𝗰𝗼𝗰𝗵𝗶𝗻𝗴 𝗻𝗵𝗶 𝗴𝘆𝗲🥰** ",
           " **𝗽𝘄 𝘀𝗲 𝗼𝗻𝗹𝗶𝗻𝗲 𝘀𝘁𝘂𝗱𝘆 𝗸𝗿𝘁𝗲 𝗵𝗼 𝗸𝘆𝗮🥰** ",
           ]" 
